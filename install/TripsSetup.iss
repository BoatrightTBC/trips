...
#define MyAppURL "https://tbcsoftware.com/trips"
#define MyAppExeName "TripsRun.bat"
#define VCLStyle "Windows10.vsf"
#define MyAppSrc "C:\TRIPS\InstallSource"
...
Source: "..\Releases\ReleaseNotes_0.68.pdf";    DestDir: "{app}"; Components: program
...
Source: "{tmp}\Trips-Gaia-raw-70.xlsx";  DestDir: "{app}\files\Excel"; ExternalSize:  1945600; Components: data\small; Flags: external
Source: "{tmp}\Trips-Gaia-raw-270.xlsx"; DestDir: "{app}\files\Excel"; ExternalSize: 98926592; Components: data\big;   Flags: external
...
[Run]
Filename: "{app}\ReleaseNotes_0.67.pdf"; Description: "Release notes for version 0.67"; Flags: postinstall shellexec; Verb: "open" 
...
begin
  if CurPageID = wpReady then begin
    ...
    if WizardIsComponentSelected('data\small') then begin
      ...
      DownloadPage.Add('https://tbcsoftware.com/trips/Datasets/Trips-Gaia-raw-70.xlsx', 'Trips-Gaia-raw-70.xlsx', '');
    end;
    if WizardIsComponentSelected('data\big') then begin
      DownloadPage.Add('https://tbcsoftware.com/trips/Datasets/Trips-normal-names-270.xlsx', 'Trips-normal-names-270.xlsx', '');
      DownloadPage.Add('https://tbcsoftware.com/trips/Datasets/Trips-Gaia-raw-270.xlsx', 'Trips-Gaia-raw-270.xlsx', '');
    end;
